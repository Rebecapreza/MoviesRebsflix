  ...
  return (
    <Router>
      <Routes>
        ...
        {/* Rotas Principais (Usam o HomeLayout que inclui a NavBar) */}
        ...
        {/* Rotas de CRUD */}
        <Route path="/filmes/cadastro" element={<HomeLayout content={<MovieForm />} />} />
        <Route path="/filmes/edicao/:id" element={<HomeLayout content={<MovieForm isEditing={true} />} />} />
      </Routes>
    </Router>
  );
}
